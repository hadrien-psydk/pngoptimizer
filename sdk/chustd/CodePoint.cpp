...
bool CodePoint::IsBaseChar(int codePoint)
{
	...
	{ 
		{0x0041, 0x005A}, {0x0061, 0x007A}, {0x00C0, 0x00D6}, {0x00D8, 0x00F6}, {0x00F8, 0x00FF}, {0}	
	};
	static const SCharRange pg01[] = 
	{
		{0x0100, 0x0131}, {0x0134, 0x013E}, {0x0141, 0x0148}, {0x014A, 0x017E}, {0x0180, 0x01C3},
		{0x01CD, 0x01F0}, {0x01F4, 0x01F5}, {0x01FA, 0x0217}, {0}
	};
	static const SCharRange pg02[] =
	{
		{0x0250, 0x02A8}, {0x02BB, 0x02C1}, {0}
	};
	...
	static const SCharRange pg04[] = 
	{
		...
		{0x04C7, 0x04C8}, {0x04CB, 0x04CC}, {0x04D0, 0x04EB}, {0x04EE, 0x04F5}, {0x04F8, 0x04F9}, {0}
	};
	static const SCharRange pg05[] = 
	{
		{0x0531, 0x0556}, {0x0559, 0x0559}, {0x0561, 0x0586}, {0x05D0, 0x05EA}, {0x05F0, 0x05F2}, {0}
	};
	static const SCharRange pg06[] = 
	{
		{0x0621, 0x063A}, {0x0641, 0x064A}, {0x0671, 0x06B7}, {0x06BA, 0x06BE}, {0x06C0, 0x06CE},
		{0x06D0, 0x06D3}, {0x06D5, 0x06D5}, {0x06E5, 0x06E6}, {0}
	};
	...
	{
		{0x0D05, 0x0D0C}, {0x0D0E, 0x0D10}, {0x0D12, 0x0D28}, {0x0D2A, 0x0D39}, {0x0D60, 0x0D61}, {0}
	};
	...
	static const SCharRange pg0E[] =
	{
		...
		{0x0EBD, 0x0EBD}, {0x0EC0, 0x0EC4}, {0}
	};
	static const SCharRange pg0F[] =
	{
		{0x0F40, 0x0F47}, {0x0F49, 0x0F69}, {0}
	};
	static const SCharRange pg10[] =
	{
		{0x10A0, 0x10C5}, {0x10D0, 0x10F6}, {0}
	};
	static const SCharRange pg11[] =
	{
		...
		{0x11F0, 0x11F0}, {0x11F9, 0x11F9}, {0}
	};
	static const SCharRange pg1E[] =
	{
		{0x1E00, 0x1E9B}, {0x1EA0, 0x1EF9}, {0}
	};
	...
	{
		{0x2126, 0x2126}, {0x212A, 0x212B}, {0x212E, 0x212E}, {0x2180, 0x2182}, {0}
	};
	static const SCharRange pg30[] =
	{
		{0x3041, 0x3094}, {0x30A1, 0x30FA}, {0}
	};
	...
	{
		pg00, pg01, pg02, pg03, pg04, pg05, pg06, null,
		null, pg09, pg0A, pg0B, pg0C, pg0D, pg0E, pg0F,

		pg10, pg11,	null, null, null, null, null, null,
		null, null, null, null, null, null, pg1E, pg1F,
		
		null, pg21, null, null,	null, null, null, null,
		null, null, null, null,	null, null, null, null,

		pg30, pg31
	};
	
	uint8 nHi = uint8(codePoint >> 8);
	if( nHi > 0x31 )
	{
	...
	// Use the pages table
	const SCharRange* const paPage = aPages[nHi];
	if( paPage == null )
		return false;
	
	int32 iRange = 0;
	while( paPage[iRange].min != 0 )
	{
		if( paPage[iRange].min <= codePoint && codePoint <= paPage[iRange].max )
			return true;
...
bool CodePoint::IsCombiningChar(int codePoint)
{
	...
	{
		int32 iRange = 0;
		while( aRanges0[iRange].min != 0 )
		{
			if( aRanges0[iRange].min <= codePoint && codePoint <= aRanges0[iRange].max )
				return true;
	...
	{
		int32 iRange = 0;
		while( aRanges1[iRange].min != 0 )
		{
			if( aRanges1[iRange].min <= codePoint && codePoint <= aRanges1[iRange].max )
				return true;
	...
	int32 iRange = 0;
	while( aRanges2[iRange].min != 0 )
	{
		if( aRanges2[iRange].min <= codePoint && codePoint <= aRanges2[iRange].max )
			return true;
